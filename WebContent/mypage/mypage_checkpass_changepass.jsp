...
<div>
	...
	<div id="wrap">
		<div id="title"><strong>My page</strong> > 비밀번호 변경 </div>
		<div id="navibar">
		...
		<div id= "table">
			<form action="mypage_change_pass.jsp" method="post" id="frm">
			<table >
				<tr>
					<th style="height:50px ; font-size:25px"> 비밀번호 변경을 위해 <br/>비비밀번호를 입력해주세요</th>
				</tr>
				<tr>
						<td style="height:45px; " >
						<input  style="height:35px; width:200px" type="password" id="pass" name="pass" />
				</tr>
				<tr>
						<td style="height:25px">
						<input type="button"  id="pass_btn" name="pass_btn" class="btn btn-warning" value=" 확인" 
